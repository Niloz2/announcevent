        ...
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6 footer-about">
            <a href="index.html" class="logo d-flex align-items-center">
              <span class="sitename">AnnounceVent</span>
            </a>
            <div class="footer-contact pt-3">
              <p>Mtendeni Street</p>
              <p>Dodoma City, Tanzania</p>
              <p class="mt-3"><strong>Phone:</strong> <span>+255 621 929 845</span></p>
              <p><strong>Email:</strong> <span>info@announcevent.com</span></p>
            </div>
          </div>
